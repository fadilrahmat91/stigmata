...
<div class="container">
	...
	<div id="alert_placeholder"></div>	
	  ...
	  <input type="hidden" class="form-control" name="simpan_toko">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="email" class="form-control" id="email_toko" name="email_toko" placeholder="email_toko" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="telp_toko" name="telp_toko" placeholder="telp_toko" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="no_rek_toko" name="no_rek_toko" placeholder="no_rek_toko" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="atas_nama_toko" name="atas_nama_toko" placeholder="atas_nama_toko" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="user_toko" name="user_toko" placeholder="user_toko" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="password" class="form-control" id="pass_toko" name="pass_toko" placeholder="pass_toko" required>
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="ulangi_pass">Ulangi Password:</label>
		  <div class="col-sm-10">
			<input type="password" class="form-control" id="ulangi_pass" name="ulangi_pass" placeholder="ulangi_pass" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<textarea class="form-control" id="alamat_toko" name="alamat_toko" placeholder="alamat_toko" required></textarea>
		  </div>
		</div>
