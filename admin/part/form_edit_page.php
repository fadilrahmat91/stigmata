...
if(isset($_POST['page_edit_simpan']))
{
	...
	if($db->query("UPDATE tbl_page SET page_isi='$page_isi', page_judul='$page_judul', page_time='$page_time' WHERE page_id='$page_id'"))
	{
...
$data = $db->query("SELECT * FROM tbl_page WHERE page_id='$page_id'")->fetch_object();
...
<div class="container">
	...
	<div id="alert_placeholder"></div>	
	  ...
	  <form class="form-horizontal" role="form" method="post" id="form_edit_page" action="">
	  <input type="hidden" class="form-control" name="page_id" id="page_id" value="<?php echo $data->page_id?>">
		...
		<div id="toogle_main_form">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<!--auto compelete-->
						<input type="text" class="form-control  page_isi" id="page_judul" name="page_isi" value="<?php echo $data->page_judul?>" required>			
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<!--auto editor-->
						<textarea class="form-control  page_isi " id="page_isi" name="page_isi" ><?php echo $data->page_isi?></textarea>
...
//submit form
$("#form_edit_page").submit(function(){
	...
	var page_edit_simpan ='';
	
	$.post("part/form_edit_page.php",{page_edit_simpan:page_edit_simpan,page_judul:page_judul,page_isi:page_isi,page_id:page_id},function(){
