...
<div class="container">
	...
	<div id="alert_placeholder"></div>	
	  ...
	  <input type="hidden" class="form-control" name="simpan_brand" value="simpan_brand">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<textarea class="form-control" id="desc_brand" name="desc_brand"  required></textarea>
		  </div>
		</div>
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<!--auto finder-->
						<input class="form-control  url_image_brand" id="url_image_brand" type="hidden" name="url_image_brand" value="" required>
						...
						<span class="help-block" id="deskripsi_help"><small>Gambar Brand (155px X 85px)</small>
