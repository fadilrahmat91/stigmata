...
<div class="container">
	...
	<div id="alert_placeholder"></div>	
	  ...
	  <input type="hidden" class="form-control" name="simpan_bank">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="nomor_rek" name="nomor_rek" placeholder="No Rek"  required>
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="nama_rek">Nama Rek:</label>
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="nama_rek" name="nama_rek" placeholder="Nama Rek"  required>
		  </div>
		</div>
