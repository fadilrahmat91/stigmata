...
$data = $db->query("SELECT * FROM tbl_kategori WHERE id_kategori='$id_kategori'")->fetch_object();

?>	
<script type="text/javascript" src="<?php echo $alamat?>admin/plugins/ckfinder/ckfinder.js"></script>
<div class="container">
	<h2>Edit <?php echo $data->nama_kategori?></h2>	
	...
	<div id="alert_placeholder"></div>	
	  ...
	  <form class="form-horizontal" role="form" method="post" id="form_tambah_kategori" action="part/simpan_tambah_kategori.php">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Nama Kategori" value="<?php echo $data->nama_kategori?>" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<textarea class="form-control" id="desc_kategori" name="desc_kategori"  required><?php echo $data->desc_kategori?></textarea>
		  </div>
		</div>
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<!--auto finder-->
						<input class="form-control  url_img_kategori" id="url_img_kategori" type="hidden" name="url_img_kategori" value="<?php echo $data->url_img_kategori?>" required>
										...
										<div class="modal-dialog">
										  ...
										  <div class="modal-content">
											<div class="modal-header">
											  ...
											  <h4 class="modal-title" id="modal_image_header"><?php echo $data->url_img_kategori?></h4>
											</div>
											<div class="modal-body">
												<div id="modal_image_content"><img src="<?php echo $data->url_img_kategori?>" width="100%"></div>
											</div>
...
$( '#main_img_show' ).html("<img src='<?php echo $data->url_img_kategori?>' class='img-thumbnail' width='300px'>");
